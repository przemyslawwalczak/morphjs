...
var Compiler = /** @class */ (function () {
    ...
    Compiler.prototype.router = function (build, container) {
        build.html("<div" + this.attribute(container.attribute) + ">");
        for (var _i = 0, _a = build.template.body.children; _i < _a.length; _i++) {
            var children = _a[_i];
    ...
    Compiler.prototype.link = function (build, container) {
    ...
    Compiler.prototype.translateKey = function (key) {
        switch (key) {
            case 'className': return 'class';
        }
        return null;
    };
    Compiler.prototype.attribute = function (attribute, merge, override) {
        if (override === void 0) { override = true; }
        var result = [];
        for (var _i = 0, _a = Array.from(attribute.keys()); _i < _a.length; _i++) {
            var key = _a[_i];
            var value = attribute.get(key);
            var translated = this.translateKey(key);
    ...
    Compiler.prototype.appContainer = function (build, container) {
    ...
    Compiler.prototype.container = function (build, container) {
        ...
        build.html("<" + container.name + this.attribute(container.attribute) + ">");
        for (var _b = 0, _c = container.children; _b < _c.length; _b++) {
            var children = _c[_b];
            if (children instanceof template_1.Container) {
                this.container(build, children);
                continue;
