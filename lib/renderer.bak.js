...
var Renderer = /** @class */ (function () {
    function Renderer() {
        ...
        this.entry = new template_1.Template();
    }
    ...
    Renderer.prototype.bundle = function (name, data) {
        if (data === void 0) { data = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
    ...
    Renderer.prototype.parseEntry = function (content, descriptor) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.entry.parse(content.toString(), descriptor)];
                    case 1:
    ...
    Renderer.prototype.parse = function (directory, config) {
        return __awaiter(this, void 0, void 0, function () {
            var entry, _i, _a, descriptor, content, template, id;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        entry = path.join(directory, config.entry);
                        _i = 0;
                    ...
                    case 3:
                        content = _b.sent();
                        if (!(entry === descriptor.absolute)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.parseEntry(content.toString(), descriptor)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 8];
                    case 5:
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, template.merge(this.entry)];
                    case 7:
                        _b.sent();
